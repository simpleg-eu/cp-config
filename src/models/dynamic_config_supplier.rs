...
pub struct DynamicConfigSupplier {
...
impl Drop for DynamicConfigSupplier {
    fn drop(&mut self) {
...
pub mod tests {
    ...
    use crate::models::config_supply_request::ConfigSupplyRequest;
    use crate::models::config_supply_response::ConfigSupplyResponse;
    use crate::models::dynamic_config_supplier::DynamicConfigSupplier;
    ...
    pub async fn run_updates_when_receives_update_request() {
        ...
        let config_supplier = DynamicConfigSupplier::new(
            get_environments(),
            downloader,
            builder,
            packager,
    ...
    fn get_config_supplier(working_dir: String) -> DynamicConfigSupplier {
